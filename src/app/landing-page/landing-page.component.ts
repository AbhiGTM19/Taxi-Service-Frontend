...
export class LandingPageComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      ScrollReveal().reveal('main .services-gif, main .amenities-gif', { origin: 'bottom', reset: false });

      ScrollReveal().reveal('main .man-with-phone-showing-thumbs-up, main .smiling-man-and-woman-with-phones')
        , { origin: 'bottom', reset: false }

      ScrollReveal().reveal('main .heading, main .text', { origin: 'bottom', reset: false });
